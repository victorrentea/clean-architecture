...
import victor.training.clean.in.rest.dto.CustomerDto.CustomerDtoBuilder;
import victor.training.clean.core.repo.CountryRepo;
import victor.training.clean.core.service.EmailSenderPort;
...
public class LargeIntegrationTest {
  ...
  void register_and_get_and_search() throws Exception {
    ...
    verify(emailSenderPort).sendEmail(argThat(email -> email.getTo().equals(CUSTOMER_EMAIL)));
