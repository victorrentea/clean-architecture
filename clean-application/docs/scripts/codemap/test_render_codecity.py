...
SAMPLE_TSV = REPO_ROOT / "clean-application/docs/generated/codemap/codemap.tsv"
...
class RenderCodecityTest(unittest.TestCase):
    def test_renders_standalone_threejs_codecity(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("CustomerApplicationService.java", html)
            self.assertIn('"district": "victor.training.clean.application.service"', html)
