...
import victor.training.clean.crm.aplication.usecase.SearchCustomerUseCase;
import victor.training.clean.crm.aplication.usecase.SearchCustomerUseCase.SearchCustomerCriteria.SearchCustomerCriteriaBuilder;
...
import static victor.training.clean.crm.aplication.usecase.SearchCustomerUseCase.*;
...
public class SearchCustomerTest {
  ...
  private static SearchCustomerCriteriaBuilder criteriaWith() {
    return SearchCustomerCriteria.builder();
  }
  @Test
  ...
  private List<SearchCustomerResult> searchAPI(SearchCustomerCriteriaBuilder searchCriteria) throws Exception {
    ...
    String responseJson = mockMvc.perform(post("/customer/search")
            ...
            .getResponse()
            .getContentAsString();
    List<SearchCustomerResult> result = jackson.readValue(responseJson, new TypeReference<>() {
    });
    return result;
  }
}
