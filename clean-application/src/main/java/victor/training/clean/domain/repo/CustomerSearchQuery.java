...
public class CustomerSearchQuery {
   ...
   public List<CustomerSearchResult> search(CustomerSearchCriteria criteria) {
      ...
      if (criteria.email() != null) {
         jpqlParts.add("UPPER(c.emailAddres) = UPPER(:emailAddres)");
...
//         predicates.add(cb.equal(cb.upper(root.get(Customer_.emailAddres)), cb.upper(cb.literal(criteria.getEmail()))));
//      }
//
