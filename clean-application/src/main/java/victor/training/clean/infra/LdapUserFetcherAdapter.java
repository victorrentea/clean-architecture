...
public class LdapUserFetcherAdapter  // avery infra name, to make it clear what you're dealing with
    implements UserService { // Adapter design pattern, the basis of a ANTI-CORRUPTION LAYER
