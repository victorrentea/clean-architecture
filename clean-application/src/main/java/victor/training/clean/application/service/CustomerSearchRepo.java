...
public class CustomerSearchRepo {
   ...
   public List<SearchCustomerResult> search(SearchCustomerCriteria criteria) {
      String jpql = "SELECT new victor.training.clean.application.dto.SearchCustomerResult(c.id, c.name)" +
                    " FROM Customer c " +
                    " WHERE ";
